export const enMessages = {
  ...
  home: {
    ...
    exploreScrollPrev: "Scroll to previous section",
  },
  explore: {
    about: {
      title: "About",
      detail: "Background, education (GPA 89/100), and professional orientation.",
    },
    experience: {
      title: "Experience",
    ...
    items: [
      {
        ...
        firm: "Jingtian & Gongcheng Law Firm, Shanghai Office",
        role: "Intern, Securities Business Department",
        bullets: [
